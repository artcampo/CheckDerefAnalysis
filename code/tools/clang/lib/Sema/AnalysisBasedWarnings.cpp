...
AnalysisBasedWarnings::IssueWarnings(sema::AnalysisBasedWarnings::Policy P,
  ...
  // Check for nullptr check after dereference
  //llvm::errs() << "NullPtrCheckAfterDereference called\n";
  {
    NullPtrCheckAfterDereferenceHandler handler;
    if (CFG *cfg = AC.getCFG()) {
      runNullPtrCheckAfterDereferenceAnalysis(*cast<DeclContext>(D), *cfg, AC,
                                      handler);
    }
  }  
